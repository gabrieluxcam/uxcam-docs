...
<Image align="center" border={false} src="https://files.readme.io/482dd7ef5b062815fe8a03040b467b24d27bb79afc9fa1ca38978d34cc183714-Uploading_dSYM_Symbols_-_Google_Docs.jpg" />

5. Set **ENABLE_USER_SCRIPT_SANDBOXING** in your Xcode project settings to **NO**.

<Image align="center" border={false} src="https://files.readme.io/7bedf23ccfb03f0d83c2bd4407f65f30793f29f1b68abbf12df82dd314607c43-dsym2.jpg" />
...
<Image align="center" border={false} src="https://files.readme.io/eef86ca61a8d6462cccc22235e161d6a960d64b8545d64a3b0b4dde78e20db71-dsym3.jpg" />
...
```c
SCRIPT=$(/usr/bin/find "${SRCROOT}" -name uxcam-upload-dsym.sh | head -n 1)
"${SCRIPT}" "app-key"
```
...
```c
SCRIPT=$(/usr/bin/find "${BUILD_DIR%Build/}SourcePackages" -name uxcam-upload-dsym.sh | head -n 1)
"${SCRIPT}" "app-key"
```
