...
excerpt: Identify users and attach custom properties to sessions in your NativeScript app
deprecated: false
hidden: false
metadata:
  title: 'User Properties - UXCam NativeScript SDK'
  description: >-
  ...
  robots: index
next:
  description: 'Identify users and attach custom properties to sessions in your NativeScript app'
---
