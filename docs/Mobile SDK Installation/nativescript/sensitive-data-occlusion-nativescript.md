...
excerpt: Hide sensitive data and PII from session recordings in your NativeScript app
deprecated: false
hidden: false
metadata:
  title: 'Sensitive Data Occlusion - UXCam NativeScript SDK'
  description: >-
...
[Sensitive Data Occlusion in WebViews Documentation](<../../ALL UXCAM APIs/screen-blurring/sensitive-views-inside-webviews.md>)