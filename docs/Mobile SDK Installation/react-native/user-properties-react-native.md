...
excerpt: Identify users and attach custom properties to sessions in your React Native app
deprecated: false
hidden: false
metadata:
  title: 'User Properties - UXCam React Native SDK'
  description: >-
  ...
  robots: index
next:
  description: 'Identify users and attach custom properties to sessions in your React Native app'
---
