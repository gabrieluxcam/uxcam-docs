...
excerpt: Identify users and attach custom properties to sessions in your Xamarin / MAUI app
deprecated: false
hidden: false
metadata:
  title: 'User Properties - UXCam Xamarin / MAUI SDK'
  description: >-
  ...
  robots: index
next:
  description: 'Identify users and attach custom properties to sessions in your Xamarin / MAUI app'
---
