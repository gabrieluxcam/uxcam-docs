...
* **User Events**  
  We automatically capture key interaction events such as taps, clicks, scrolls, and page navigations. ➜ [Learn how to add custom event tagging](https://developer.uxcam.com/docs/logging-custom-events)
* **Page Visits**  
  All page views are captured automatically. ➜ [Use code-less page definition to organise your pages without touching code](https://developer.uxcam.com/docs/define-pages-properties)
* **Sensitive Data Protection**  
  Inputs such as passwords and email fields are auto-occluded to protect user privacy. ➜ [Explore additional occlusion options](https://developer.uxcam.com/docs/occlusion-hide-sensitive-data)
* **User Identification**  
  We identify users based on anonymous browser/device IDs by default. ➜ [You can enhance this by using functions to set user identity and properties](https://developer.uxcam.com/docs/setting-user-properties)

# Content Security Policy (CSP)

If your website uses a Content Security Policy (CSP), you'll need to explicitly allow UXCam resources for the Web SDK to function properly. Without this, session recordings and script loading may be blocked. ➜ [Learn how to configure your CSP to safely enable UXCam in our Content Security Policy setup guide](https://developer.uxcam.com/docs/configure-content-security-policy-csp)
